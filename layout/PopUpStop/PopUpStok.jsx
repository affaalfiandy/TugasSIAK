...
import { BackdropPembelian, KolomInput, PopUpLayer, TabelInput } from "./PopUpStok.style"
import { P } from "../../components/typography/typo"


const PopUpStok = (props) =>{
        ...
        <BackdropPembelian>
            <PopUpLayer>
                <TabelInput>
                    ...
                    <KolomInput>
                    <Label for="pet-select">Pilih Vendor</Label>
